## Truy cập nguồn [```HistData.com```](https://www.histdata.com/) để tải các loại dữ liệu cặp tiền mới nhất.
1. Hệ thống tín hiệu giao dịch BTC/USD, khung 15m. [```Link repo.```](https://github.com/phucoding286/btc-trade-signal-15m-algo) (Hổ trợ bot OKX) (Tối ưu cho sàn crypto)
